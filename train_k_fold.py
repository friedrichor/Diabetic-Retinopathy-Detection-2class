...
from utils_k_fold import k_fold_read_split_data, read_split_data, create_lr_scheduler, get_params_groups, train_one_epoch, evaluate
import params
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str,
                        default=params.ROOT / '../drive/MyDrive/torch_convnext/convnext_large_1k_224_ema.pth',
